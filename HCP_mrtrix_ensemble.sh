...
# The current version of the script handles only data on the local Indiana University Cluster Systems
...
TOPDIR=/N/dc2/projects/lifebid/wm_morphology/HCP_3T_test/$SUBJ
...
# convert dwi's 
mrconvert $TOPDIR/diffusion_data/dt6/$DWIFILENAME.nii.gz $OUTDIR/${DWIFILENAME}_dwi.mif
...
# fit tensors
cp -v  $TOPDIR/tractography/data_b1000.b $OUTDIR/${DWIFILENAME}.b
